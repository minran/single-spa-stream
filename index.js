...
function pathnamePrefix(prefix) {
  return function (location) {
    return location.pathname.startsWith("".concat(prefix));
  };
}

function loadApp(_x, _x2, _x3, _x4, _x5) {
  return _loadApp.apply(this, arguments);
}

function _loadApp() {
  _loadApp = asyncToGenerator(
  /*#__PURE__*/
  regenerator.mark(function _callee(name, hash, appURL, storeURL, globalEventDistributor) {
    var storeModule, customProps;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            storeModule = {}, customProps = {
          ...
          case 12:
            ...
            console.log("Could not load store of app ".concat(name, "."), _context.t1);

          case 15:
            if (storeModule.storeInstance && globalEventDistributor) {
              // add a reference of the store to the customProps
              customProps.store = storeModule.storeInstance; // register the store with the globalEventDistributor
            ...
            }, pathnamePrefix(hash), customProps);
...
export { GlobalEventDistributor, loadApp };
